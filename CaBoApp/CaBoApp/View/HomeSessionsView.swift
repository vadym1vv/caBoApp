            ...
            ScrollView {
                VStack {
                    ForEach(placesModel) { homeSessionModel in
                        SingleRowCardComponent(itemName: homeSessionModel.title, itemDescription: homeSessionModel.timeForSession.longDescription, itemImg: homeSessionModel.image, background: .colEDE7FA, categoryEnum: CategoryEnum.homeSessions, showMinutesIcon: true) {

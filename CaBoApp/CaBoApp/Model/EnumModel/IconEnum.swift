...
enum IconEnum: String {
    case onboardingImg1, onboardingImg2, onboardingImg3, placeButton, settings, homeSessionsButton, cultureLessonsButton, cocktailsButton, startSessionImg, favIconOff, favIconOn,
         backBtn, ingredientIcon, cocktailListImage, componentUnitFacts, componentUnitOrigin, componentUnitStory, cultureReflect, culturePrepare, cultureMix, cultureListen, searchFieldIcon, starDifficulty1Enum, timeNeededIcon, deleteIcon
